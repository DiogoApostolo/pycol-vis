...
# pyco-vis: Python Image Complexity Library

The Python Image Complexity Library (`pyco-vis`) assembles a set of data complexity measures associated with image data. 
...
All packages required to run pyco-vis are listed in the requirements.txt file found in this github repository. To install all needed packages run:
